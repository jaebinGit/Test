...
sub = rankTikitakaRate;
num_samples = 1000;

X = sub; % 독립변수
Y1 = tikLongPassTry; % 종속변수 1
Y2 = tikThroughPassTry; % 종속변수 2
Y3 = tikDirrble; % 종속변수 3
Y4 = tikShootOutPenalty; % 종속변수 4
Y5 = tikPassTry; % 종속변수 5
Y6 = tikShootInPenalty; % 종속변수 6
